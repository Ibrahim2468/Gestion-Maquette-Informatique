...
<script type="text/javascript" charset="utf-8" async="" src="Bon/button.js"></script>
</head>
<body>
	...
	<div class="center">
        <h2 class="teal-text header center-text">Connectez-Vous</h2>
    </div>
  ...
  <form class="col s12" method="post" action="Connection">
    <div class="row">
      ...
      <div class="input-field col s12">
        ...
        <input id="identifiant" type="text" class="validate" name="identifiant" />
      ...
      <div class="input-field col s12">
        ...
        <span class="red-text">${erreurs['passe'] }</span>
      </div>
      <span class="red-text center">${pas }</span>
      
		<div>
		<button class="btn waves-effect waves-light" type="submit" name="action">Submit
		  <i class="material-icons right">send</i>
		</button>
		<a class="teal-text right" href="Oublie">Mot de passse oublié ?</a>
