...
<body>
	...
	<div class="row djina">
  <form class="col s12" method="post" action="ModifierSemestre">
    <div class="row">
      <h2 class="header center-text">Ajout d'une Semestre</h2>
      <div class="input-field col s12">
      	<i class="material-icons prefix">account_circle</i>
        <input id="nom" type="text" class="validate" name="nom" value="${semestre.nom_semestre }" />
        <label for="nom">Nom du semestre</label>
      </div>
	<div class="input-field col s12">
	  <select name="classe">
