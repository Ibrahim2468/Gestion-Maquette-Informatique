...
<body>
	...
	<div class="row djina">
  <form class="col s12" method="post" action="CreationEnseignant">
    <div class="row">
      <h2 class="teal-text header center-text">Ajout d'un Enseignant</h2>
    ...
    <div class="input-field col s6">
      <input id="discipline" type="text" class="validate" name="discipline" />
