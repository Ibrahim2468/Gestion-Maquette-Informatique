...
<body>
	...
	<c:import url="menu_thiam.jsp" />
      ...
      <ul class="collection with-header djina">
        <li class="collection-header"><h4>Liste des salles.</h4></li>
        
        <c:forEach items="${salles}" var="news">
        	<li class="collection-item">
        		<div>${news.nom_salle}
        		
        			<a href="SupprimerSalle?val=${news.id_salle }" class="secondary-content">
	        			<i class="material-icons">
	        				delete
	        			</i>
        			</a>
        			
        			<a href="ModifierSalle?val=${news.id_salle }" class="secondary-content">
	        			<i class="material-icons">
	        				mode_edit
	        			</i>
        			</a>
        			
        			<a href="ListeSalle?val=${news.id_salle }" class="secondary-content">
	        			<i class="material-icons">
	        				visibility
	        			</i>
        			</a>       
