...
<body>
	...
	<div class="row djina">
		<form class="col s12" method="post" action="CreationMatiere">
			<div class="row">
				<h2 class="teal-text header center-text">Ajout d'une matière</h2>
				<div class="input-field col s12">
					<input id="intitule" type="text" class="validate" name="intitule" />
				...
				<a class="teal btn right" href="ChefDeDepartement"><i class="material-icons left">delete</i>ANNULER</a>
			</div>
		</form>
	</div>
