...
<body>
	...
	<div class="row djina">
  <form class="col s12" method="post" action="CreationClasse">
    <div class="row">
      <h2 class="teal-text header center-text">Ajout d'une classe</h2>
      <div class="input-field col s12">
      	<i class="material-icons prefix">account_circle</i>
        <input id="nomClasse" type="text" class="validate" name="nomClasse" />
        <label for="nomClasse">Nom Classe</label>
      </div>
      <div class="input-field col s12">
       	<i class="material-icons prefix">email</i>
        <input id="emailClasse" type="email" class="validate" name="emailClasse">
