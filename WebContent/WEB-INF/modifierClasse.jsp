...
<body>
	...
	<div class="row djina">
  <form class="col s12" method="post" action="ModifierClasse">
    <div class="row">
      <h2 class="teal-text header center-text">Ajout d'une classe</h2>
      <div class="input-field col s12">
      	<i class="material-icons prefix">account_circle</i>
        <input id="nomClasse" type="text" class="validate" name="nomClasse" value="${classe.nom_classe }" />
        <label for="nomClasse">Nom Classe</label>
      </div>
      <div class="input-field col s12">
       	<i class="material-icons prefix">email</i>
        <input id="emailClasse" type="email" class="validate" name="emailClasse" value="${classe.email_classe }" />
        <label for="emailClasse">Email du responsable de classe</label>
      </div>
	
<!-- 	    <a href="openclass.com"class="left waves-effect waves-light btn">button</a> -->
		
		<button class="teal btn waves-effect waves-light" type="submit" name="action">Submit
