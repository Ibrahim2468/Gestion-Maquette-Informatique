...
<body>
	...
	<div class="row djina">
  <form class="col s12" method="post" action="Oublie">
    <div class="row">
      <h2 class="teal-text header center-text">Récupération </h2>
      ...
      <div class="input-field col s12">
	      <span class="red-text">${pas }</span>
      </div> 
		<button class="teal btn waves-effect waves-light" type="submit" name="action">Submit
		  <i class="material-icons right">send</i>
		</button>
		<a class="teal btn right" href="Connection"><i class="material-icons left">delete</i>ANNULER</a>
