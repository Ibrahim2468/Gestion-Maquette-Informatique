...
<body>
	...
	<c:import url="menu_thiam.jsp" />
      ...
      <ul class="collapsible popout djina" data-collapsible="accordion">
        <li class="collection-header"><h4>Liste des cours.</h4></li>
        	<c:forEach items="${cours}" var="news">
	        	<li>
			      <div class="collapsible-header"><i class="material-icons right">done</i>${news.nom_cour}</div>
...
<%--         			<a href="SupprimerSemestre?val=${news.id_semestre }" class="secondary-content"> --%>
<!-- 	        			<i class="material-icons"> -->
<!-- 	        				delete -->
<!-- 	        			</i> -->
<!--         			</a> -->
        			
<%--         			<a href="ModifierSemestre?val=${news.id_semestre }" class="secondary-content"> --%>
<!-- 	        			<i class="material-icons"> -->
<!-- 	        				mode_edit -->
<!-- 	        			</i> -->
<!--         			</a> -->
        			
<%--         			<a href="ListeSemestre?val=${news.id_semestre }" class="secondary-content"> --%>
<!-- 	        			<i class="material-icons"> -->
<!-- 	        				visibility -->
<!-- 	        			</i> -->
<!--         			</a>        -->
