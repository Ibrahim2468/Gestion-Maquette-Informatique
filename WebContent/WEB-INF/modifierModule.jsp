...
<body>
	...
	<div class="row djina">
  <form class="col s12" method="post" action="ModifierModule">
    <div class="row">
      <h2 class="header center-text teal-text">Modification d'un module</h2>
      <div class="input-field col s12">
      	<i class="material-icons prefix">account_circle</i>
        <input id="nom" type="text" class="validate" name="nom" value="${module.nom_module }" />
        <label for="nom">Nom du module</label>
      </div>
	<div class="input-field col s12">
	  <select name="semestre">
	    <option value="" disabled selected></option>
	    <c:forEach items="${semestres}" var="news">
	    	<option value="${news.id_semestre}"> ${news.nom_semestre }</option>
	    </c:forEach>
	  </select>
