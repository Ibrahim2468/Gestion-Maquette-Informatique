...
<body>
	...
	<div class="row djina">
  <form class="col s12" method="post" action="ModifierSalle">
    <div class="row">
      <h2 class="teal-text header center-text">Ajout d'une salle</h2>
      <div class="input-field col s12">
      	<i class="material-icons prefix">account_circle</i>
        <input id="nomSalle" type="text" class="validate" name="nomSalle" value="${salle.nom_salle }" />
