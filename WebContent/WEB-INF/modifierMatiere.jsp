...
<body>
	...
	<div class="row djina">
		<form class="col s12" method="post" action="ModifierMatiere">
			<div class="row">
				<h2 class="teal-text header center-text">Ajout d'une matière</h2>
				<div class="input-field col s12">
					<input id="intitule" type="text" class="validate" name="intitule" value="${matiere.intitule_matiere }" />
					<label for="intitule">Intitule</label>
				</div>
				<div class="input-field col s12">
					<input id="volume" type="number" class="validate" name="volume" value="${matiere.volume_matiere }" />
				...
				<div class="input-field col s12">
				  <select name="module">
				    ...
				    <c:forEach items="${modules}" var="news">
				    	<option value="${news.id_module}"> ${news.nom_module }</option>
				    </c:forEach>
				  </select>
				  <label for="module">Module</label>
				</div>
				<button class="teal btn waves-effect waves-light" type="submit" name="action">Valider
