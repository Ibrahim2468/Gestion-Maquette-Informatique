...
<body>
	...
	<c:import url="menu_thiam.jsp" />
      ...
      <ul class="collection with-header djina">
        <li class="collection-header"><h4>Liste des classes.</h4></li>
        
        <c:forEach items="${classes}" var="news">
        	<li class="collection-item">
        		<div>${news.nom_classe}
        		
        			<a href="SupprimerClasse?val=${news.id_classe }" class="secondary-content">
	        			<i class="material-icons">
	        				delete
	        			</i>
        			</a>
        			
        			<a href="ModifierClasse?val=${news.id_classe }" class="secondary-content">
	        			<i class="material-icons">
	        				mode_edit
	        			</i>
        			</a>
        			
        			<a href="ListeClasse?val=${news.id_classe }" class="secondary-content">
	        			<i class="material-icons">
	        				visibility
	        			</i>
        			</a>       
