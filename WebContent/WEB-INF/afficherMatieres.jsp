...
<body>
	...
	<c:import url="menu_thiam.jsp" />
      ...
      <ul class="collection with-header">
        <li class="collection-header"><h4>Liste des Matieres.</h4></li>
        
        <c:forEach items="${matieres}" var="news">
        	<li class="collection-item">
        		<div>${news.intitule_matiere}
        		
        			<a href="SupprimerMatiere?val=${news.id_matiere }" class="secondary-content">
	        			<i class="material-icons">
	        				delete
	        			</i>
        			</a>
        			
        			<a href="ModifierMatiere?val=${news.id_matiere }" class="secondary-content">
	        			<i class="material-icons">
	        				mode_edit
	        			</i>
        			</a>
        			
        			<a href="ListeMatiere?val=${news.id_matiere }" class="secondary-content">
	        			<i class="material-icons">
	        				visibility
	        			</i>
        			</a>       
