...
/**
 * Servlet implementation class ListeModule
 */
@WebServlet("/ListeModule")
public class ListeModule extends HttpServlet {

	private static final long serialVersionUID = 1L;
	private static final String VUE_DEFAULT = "/WEB-INF/afficherModule.jsp";
	...
	protected void doGet(HttpServletRequest request,
		...
		System.out.println(module.getSemestre().getNom_semestre());
